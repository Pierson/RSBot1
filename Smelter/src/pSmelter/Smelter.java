...
@Manifest(name = "pSmelter", description = "Your AIO Smelting Experience.", authors = {"Piers"}, version = 1.4)
public class Smelter extends PollingScript implements PaintListener, MessageListener {
   ...
   // Data \\
	...
	g.drawString("Play in Old School mode", 200, 50);
	...
	g.drawString("pSmelter v1.4", 25, 15);
