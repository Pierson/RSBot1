...
@Manifest(name = "Clay Softener", description = "Money-making", authors = {"Piers"}, version = 1.1)
public class Softener extends PollingScript implements PaintListener, MessageListener {
	...
	perHour = (int) ((amount) * 3600000D / (System.currentTimeMillis() - startTime));
	...
	g.drawString("Clay Softened: " +amount +" ("+perHour+")", 5, 65);
	g.drawString("" +status, 5, 85);
	g.drawString("FPS: " +fps, 5, 105);
	g.setFont(new Font("Tahoma", Font.BOLD, 14));
	g.drawString("Clay Softener v1.1", 25, 15);
