...
@Manifest(name = "pFletch AIO", description = "Your AIO Fletching Experience. Supports cutting, stringing, and adding bolt tips!", version = 1.1, topic = 1134830)
public class Fletcher extends PollingScript implements PaintListener, MessageListener {
    ...
    final BufferedImage image = downloadImage("http://i.imgur.com/6Jkuuqe.png");
